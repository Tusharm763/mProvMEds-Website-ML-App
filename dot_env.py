...
MY_EMAIL_FOR_CONTACT = 'mistrytushar07@gmail.com' # os.environ.get('ver')
# EMAIL_PASSWORD = os.getenv('email_password')
EMAIL_PASSWORD = os.environ.get('email_password')
# ADMIN_PASSWORD = os.getenv('admin_pass')
ADMIN_PASSWORD = 'mProvMEds' # os.environ.get('admin_pass')

# HTML_APP_TITLE  = os.getenv('appname')
HTML_APP_TITLE  = 'mProvMEds ' # os.environ.get('appname')
# APP_VERSION = os.getenv('ver')
APP_VERSION = '2.0.0' # os.environ.get('ver')
# UPDATED_ON = os.getenv('date')
UPDATED_ON = '2 September 2025 (2.0.0)' # os.environ.get('date')
# SUPPORT_EMAIL= os.getenv('s_email')
SUPPORT_EMAIL= 'mistrytushar07@gmail.com' # os.environ.get('s_email')
# SUPPORT_PHONE= os.getenv('s_phone')
SUPPORT_PHONE= '+91 941-350-0817' # os.environ.get('s_phone')
